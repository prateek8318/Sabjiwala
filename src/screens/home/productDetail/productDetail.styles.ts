...
export default StyleSheet.create({
  ...
  weightRatingRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: wp(4), marginTop: hp(0.8) },
  weightText: { fontSize: wp(4), color: '#666', fontFamily: Fonts.Medium },
  starRatingContainer: { flexDirection: 'row', alignItems: 'center', gap: 2 },
  starIcon: { marginHorizontal: 1 },
  ratingValue: { fontSize: wp(3.8), color: '#666', marginLeft: wp(1.5), fontFamily: Fonts.Medium },
